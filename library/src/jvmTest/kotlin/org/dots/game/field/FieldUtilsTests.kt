...
""".trimIndent())
    ...
    fun clone() {
        ...
        assertEquals(10, field.numberOfLegalMovesIfSuicideAllowed)
        assertEquals(field.numberOfLegalMovesIfSuicideAllowed, newField.numberOfLegalMovesIfSuicideAllowed)
