...
that is a Bronstein delay."""
    ...
    override val resetSettings = "Reset the settings"
    override val resetSettingsDescription = "Drops every setting of the app, so that it starts the way it " +
            "starts for the very first time the next time it's started. Nothing is saved until then."
    override val settingsAreReset = "Restart the app to start it anew"
