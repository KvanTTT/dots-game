...
class SettingsTests {
    ...
    fun saving() {
        fun <T : ClassSettings<T>> checkSaveAndExistence(classSettings: ClassSettings<T>) {
            if (classSettings is WindowSettings) {
                ...
                saveClassSettings(classSettings.Default as T, directory = TEMP_DIRECTORY)
            }
        ...
        checkSaveAndExistence(CurrentGameSettings.Default)
    ...
    fun bigString() {
        val bigString = """
            ...
            """.trimIndent()
        val currentGameSettings = CurrentGameSettings(
            path = null,
            bigString,
            currentGameNumber = 0,
            currentNodeNumber = 0,
        ...
        assertTrue(saveClassSettings(currentGameSettings, directory = TEMP_DIRECTORY))
